---
title: "Service: frontend (Angular SPA)"
description: "The Angular SPA's role, Faro browser instrumentation, nginx configuration, and browser-to-backend trace linkage."
tags: ["ShipSolid", "Signal Forge", "Services"]
updated: 2026-07-10
zettelId: "202607091847-37"
relations:
...
When the Angular SPA calls any [[projects/app-signal-forge/api/rest|REST]] endpoint,
`TracingInstrumentation` injects a `traceparent` header:
