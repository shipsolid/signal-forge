---
title: "Log-to-Trace Correlation"
description: "How SignalForge correlates logs to traces via node-level tailing and Loki structured metadata, across both local and cloud monitoring modes."
tags: ["ShipSolid", "Signal Forge", "Observability"]
updated: 2026-07-10
zettelId: "202607091847-22"
relations:
...
See [[adr-log-tailing-not-otlp-export|ADR-001]]. Short version: production-parity, simpler
application code, independent reliability.
